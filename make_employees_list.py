...
class ManagerEmployeesListScreen extends StatefulWidget {
  ...
  @override
  State<ManagerEmployeesListScreen> createState() => _ManagerEmployeesListScreenState();
}

class _ManagerEmployeesListScreenState extends State<ManagerEmployeesListScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final uri = Uri.parse('https://jssolutions-eg.com/attendance/api/mobile/manager/employees/')
  ...
  Color _statusColor(String? code) {
    switch (code) {
      ...
      case 'on_leave': return Colors.blue;
                        ...
                        : RefreshIndicator(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, i) {
                                ...
                                final color = _statusColor(emp['status_code']);
                                return Container(
                                  ...
                                  child: ListTile(
                                    ...
                                    leading: CircleAvatar(
                                      ...
                                      backgroundImage: (emp['photo'] != null && emp['photo'].toString().isNotEmpty)
...
path = r'lib\screens\manager\manager_employees_list_screen.dart'
