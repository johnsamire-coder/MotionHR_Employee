...
const Color kPrimaryDark = Color(0xFF382483);
const Color kAccentColor = Color(0xFF00C688);
          ...
          content: Column(
            ...
            children: [
              Icon(
                  ...
                  size: 60,
                  color:
                      _isEveningMessage ? Color(0xFF1A0A3E) : Colors.orange),
              const SizedBox(height: 16),
              Text(
                _isEveningMessage
      ...
      builder: (context) => AlertDialog(
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: Color(0xFF382483).withValues(alpha: 0.08),
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(color: Color(0xFF382483).withValues(alpha: 0.2)),
                ),
                child: Row(children: [
                  const Icon(Icons.location_on, color: Color(0xFF382483)),
                  const SizedBox(width: 8),
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: Color(0xFF382483), foregroundColor: Colors.white),
        ...
        children: [
          ...
          const SizedBox(height: 16),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color:
                    canCheckOut ? Colors.green[50] : Color(0xFFEDEAF7),
                borderRadius: BorderRadius.circular(16),
                border: Border.all(
                    color: canCheckOut
                        ? Colors.green[200]!
          ...
          if (allowPartialCheckout && checkedIn && !checkedOut) ...[
            ...
            if (sessionsToday > 0)
              Container(
                ...
                decoration: BoxDecoration(
                  color: Color(0xFF00C688).withValues(alpha: 0.08),
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(color: Color(0xFF00C688).withValues(alpha: 0.2)),
                ),
                child: Row(
                  children: [
                    const Icon(Icons.schedule, color: Color(0xFF00C688), size: 18),
                    const SizedBox(width: 8),
                    Text(
                      isAr
                          ? 'عدد فترات العمل اليوم: $sessionsToday'
                          : 'Work sessions today: $sessionsToday',
                      style: const TextStyle(color: Color(0xFF00C688), fontSize: 13),
                    ),
                  ],
                ),
              ),
...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Color _typeColor(String type) {
    ...
    if (type == 'work_location_proposed') return Color(0xFF1A0A3E);
    if (type.contains('new_')) return Color(0xFF382483);
    if (type.contains('attendance')) return Color(0xFF00C688);
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                    border:
                        Border.all(color: Color(0xFFB8AEE3)),
                  ),
                  child: Row(
                    children: [
                      Icon(Icons.attach_file,
                      ...
                      Icon(Icons.open_in_new,
                          color: Color(0xFF382483), size: 18),
                    ],
                  ),
                ),
              ),
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Row(
              children: [
                const Icon(Icons.info, color: Color(0xFF382483)),
                const SizedBox(width: 8),
                Expanded(
                  child: Text(
                    isAr
        ...
        child: Scaffold(
          ...
          body: ListView(padding: const EdgeInsets.all(16), children: [
            Container(
              ...
              decoration: BoxDecoration(
                  gradient: const LinearGradient(
                      colors: [Color(0xFF00C688), kPrimaryColor]),
                  borderRadius: BorderRadius.circular(12)),
              child: Column(children: [
                const Icon(Icons.description,
                    color: Colors.white, size: 40),
          ...
          Row(
            ...
            children: [
              ...
              _miniPie(
                ...
                const Color(0xFF382483).withValues(alpha: 0.15),
              ),
            ],
          ),
        ],
  ...
  Widget build(BuildContext context) {
    ...
    if (_items.isEmpty) {
      return EmptyStateWidget(
        ...
        iconColor: const Color(0xFF382483),
      );
    }
    return RefreshIndicator(
        onRefresh: _load,
