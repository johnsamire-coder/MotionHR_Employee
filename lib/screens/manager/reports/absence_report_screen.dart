...
class _AbsenceReportScreenState extends State<AbsenceReportScreen> {
  ...
  Future<void> _print() async {
    ...
    try {
      ...
      await ReportPdfService.printReport(
        title: _isAr ? 'تقرير الغياب' : 'Absence Report',
  ...
  Widget build(BuildContext context) {
    ...
    final title = _isAr ? 'تقرير الغياب' : 'Absence Report';
                ...
                children: [
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        _chip(
                          _isAr ? 'أيام العمل' : 'Working Days',
                          '${_data?['total_working_days_in_month'] ?? 0}',
                        ),
                        const SizedBox(width: 8),
                        _chip(
                          _isAr ? 'موظفين غائبين' : 'Absent Employees',
  ...
  Widget _buildCard(Map<String, dynamic> emp) {
    ...
    final absentDays = emp['absent_days'] ?? 0;
    final workingDays = emp['total_working_days'] ?? 0;
    final absentDates = (emp['absent_dates'] as List?) ?? [];
    ...
    return Card(
      ...
      child: ExpansionTile(
        ...
        subtitle: Text(
          _isAr
              ? 'غياب: $absentDays / $workingDays يوم'
              : 'Absent: $absentDays / $workingDays days',
          ...
          if (absentDates.isNotEmpty) ...[
            Padding(
              ...
              child: Align(
                ...
                child: Text(
                  _isAr ? 'تواريخ الغياب:' : 'Absent Dates:',
                  style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.w600,
