...
import 'payroll_run_screen.dart'; // ده الربط الجديد
        ...
        children: [
          Card(
            child: ListTile(
              ...
              subtitle: Text(
                isAr
                    ? 'ملخص الرواتب - التشغيل - الإعدادات - أيام العمل'
                    : 'Payroll Summary - Runs - Settings - Work Days',
              ),
            ),
          ),
          ...
          _card(
            ...
            subtitle: isAr
                ...
                : 'Create, approve and lock payroll runs',
            screen: const PayrollRunScreen(),
          ),
          _card(
            context: context,
            isAr: isAr,
