...
class AllowanceRuleService {
  static const String _baseUrl  = 'https://jssolutions-eg.com';
  static const String _basePath = '/attendance/api/mobile/manager/rules/allowance';
  ...
  static Future<List<dynamic>> listRules() async {
    ...
    throw Exception('Failed to load allowance rules: ${res.statusCode}');
  }
