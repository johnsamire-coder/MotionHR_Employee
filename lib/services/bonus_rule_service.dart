...
class BonusRuleService {
  ...
  static const String _basePath = '/attendance/api/mobile/manager/rules/bonus';
  ...
  static Future<List<dynamic>> listRules() async {
    ...
    throw Exception('Failed to load bonus rules: ${res.statusCode}');
  }
  ...
  static Future<Map<String, dynamic>> getRule(int id) async {
    ...
    throw Exception('Failed to load bonus rule: ${res.statusCode}');
  }
